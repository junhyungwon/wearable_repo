...
#  NEXX360M:
#    ====> STREAMING: OFF, CAM: 1CH, GPS: OFF, HDMI: ON, VOIP: OFF, BUZZER: OFF
#  NEXXB:
#    ====> STREAMING: ON, CAM: 3CH, GPS: OFF, HDMI: ON, VOIP: ON, BUZZER: ON
#  NEXXB_ONE:
#    ====> STREAMING: ON, CAM: 1CH, GPS: OFF, HDMI: ON, VOIP: ON, BUZZER: ON
#  NEXXONE_VOIP:
#    ====> STREAMING: ON, CAM: 1CH, GPS: ON, HDMI: OFF, VOIP: ON, BUZZER: ON
#  NEXXONE_CCTV_SA:
#    ====> STREAMING: ON, CAM: 4CH, GPS: OFF, HDMI: OFF, VOIP: OFF, BACKCHANNEL_AUDIO: ON, BUZZER: ON
#  NEXX360W_MUX:
#    ====> STREAMING: ON, CAM: 4CH, GPS: ON, HDMI: OFF, VOIP: OFF, REC: 1(merged), STREAM :1 (merged), BUZZER: ON
#  NEXX360C: NEXX360 Basic for CCTV
#    ====> STREAMING: OFF, CAM: 4CH, GPS: OFF, HDMI: OFF, VOIP: OFF, BUZZER: ON
#  NEXX360W_CCTV: NEXX360 Wireless for CCTV
#    ====> STREAMING: ON, CAM: 4CH, GPS: OFF, HDMI: OFF, VOIP: OFF, BACKCHANNEL_AUDIO: ON, BUZZER: ON
#  NEXX360W_CCTV_SA: NEXX360 Wireless for CCTV STAND ALONE
#    ====> STREAMING: ON, CAM: 4CH, GPS: OFF, HDMI: OFF, VOIP: OFF, BACKCHANNEL_AUDIO: ON, BUZZER: ON
#
...
SYSTEM_PLATFORM := NEXXONE_CCTV_SA
