...
static const u8 aic3x_reg[AIC3X_CACHEREGNUM] = {
	...
	0x00, 0x00, 0x04, 0x00,	/* 36 */ /* 38:short circuit protect */
	0x00, 0x00, 0x00, 0x80,	/* 40 */
	0x80, 0x00, 0x00, 0x00,	/* 44 */
	0x00, 0x00, 0x00, 0x64,	/* 48 */ /* 51:HPLOUT->6dB */
	0x00, 0x00, 0x00, 0x00,	/* 52 */
	0x00, 0x00, 0x64, 0x00,	/* 56 */ /* 58:HPLCOM->6dB */
	0x00, 0x00, 0x00, 0x00,	/* 60 */
	0x00, 0x64, 0x00, 0x00,	/* 64 */ /* 65:HPROUT->6dB */
	0x00, 0x00, 0x00, 0x00,	/* 68 */
	0x64, 0x00, 0x00, 0x00,	/* 72 */ /* 72:HPRCOM->6dB */
...
/*
 * SOC_ENUM_SINGLE_DECL(name, xreg, xshift, xtexts)
 */
...
/*
 * SOC_ENUM_DOUBLE_DECL(name, xreg, xshift_l, xshift_r, xtexts)
 */
...
static const char *aic3x_agc_attack[] = {
	"8ms", "11ms", "16ms", "20ms" };
...
static const char *aic3x_agc_decay[] = {
...
/*
 * Line out gain volumes. From 0 to 9dB in 1.0 dB steps. mute -> 0
 * DECLARE_TLV_DB_SCALE(name, min, step, mute)
 */
static DECLARE_TLV_DB_SCALE(line_out_tlv, 0, 100, 0);
#endif
...
static const struct snd_kcontrol_new aic3x_right_pga_mixer_controls[] = {
	/*
	 * SOC_DAPM_SINGLE_AIC3X(xname, reg, shift, mask, invert)
	 */
...
static int aic3x_add_widgets(struct snd_soc_codec *codec)
{
	...
	case AIC3X_MODEL_33:
		...
		snd_soc_dapm_new_controls(codec, aic3x_extra_dapm_widgets,
					ARRAY_SIZE(aic3x_extra_dapm_widgets));
		/* set up audio path interconnects */
		snd_soc_dapm_add_routes(codec, intercon,
					ARRAY_SIZE(intercon));
		snd_soc_dapm_add_routes(codec, intercon_extra,
					ARRAY_SIZE(intercon_extra));
#ifndef CONFIG_SND_TI81XX_SOC_UD
		snd_soc_dapm_new_controls(codec, aic3x_dapm_mono_widgets,
					ARRAY_SIZE(aic3x_dapm_mono_widgets));
		snd_soc_dapm_add_routes(codec, intercon_mono,
					ARRAY_SIZE(intercon_mono));
#endif /* AIC3101 isn't supported */
		break;
	case AIC3X_MODEL_3007:
		...
		snd_soc_dapm_add_routes(codec, intercon_extra,
					ARRAY_SIZE(intercon_extra));
		snd_soc_dapm_add_routes(codec, intercon_3007,
					ARRAY_SIZE(intercon_3007));
		break;
	case AIC3X_MODEL_3104:
		snd_soc_dapm_new_controls(codec, aic3x_dapm_widgets,
				  	ARRAY_SIZE(aic3x_dapm_widgets));
		snd_soc_dapm_new_controls(codec, aic3104_extra_dapm_widgets,
				ARRAY_SIZE(aic3104_extra_dapm_widgets));
		/* set up audio path interconnects */
		snd_soc_dapm_add_routes(codec, intercon,
					ARRAY_SIZE(intercon));
		snd_soc_dapm_add_routes(codec, intercon_extra_3104,
			     ...
			     unsigned int fmt)
{
	 ...
	 * not required synced to hardware
	 */
	codec->cache_sync = 0;
...
static int aic3x_probe(struct snd_soc_codec *codec)
{
	 ...
	 * if cache_only is set, don't write hardware(disable i2c)
	 */
	codec->cache_only = 1;
	aic3x_init(codec);
	...
	case AIC3X_MODEL_33:
		...
		snd_soc_add_controls(codec, aic3x_extra_snd_controls,
			   ...
			   const struct i2c_device_id *id)
{
	...
	if (pdata) {
		...
		aic3x->gpio_reset = -1;
		aic3x->micbias_vg = AIC3X_MICBIAS_OFF; /* set default */
	}
...
err_get:
	regulator_bulk_free(ARRAY_SIZE(aic3x->supplies),
		aic3x->supplies);
err_gpio:
	if (gpio_is_valid(aic3x->gpio_reset))
