...
#ifndef __CONFIG_FIT_H
#define __CONFIG_FIT_H
...
# define CONFIG_SYS_PROMPT			"FIT-MIN # "
# define CONFIG_BOOTDELAY			0

# if defined(CONFIG_NAND_BOOT)		/* Autoload the 2nd stage from NAND */
...
#  define CONFIG_EXTRA_ENV_SETTINGS \
	"verify=yes\0" \
	"bootcmd=mmc rescan; fatload mmc 0 0x80800000 u-boot_fit.bin; go 0x80800000\0" \
...
#  define CONFIG_EXTRA_ENV_SETTINGS \
	"verify=yes\0" \
	"bootcmd=setenv autoload no;dhcp; tftp 0x81000000 u-boot_fit.bin; go 0x81000000\0"
# endif
...
# define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"fi\0" \
	"logo=" \
	"nand read 0x82000000 0x00120000 0xB0000;logo on 0x82000000\0" \

# define CONFIG_BOOTCOMMAND \
	"run update;nboot.e 0x81000000 0 0x00220000;bootm 0x81000000; " \

# define CONFIG_BOOTARGS \
	"mem=180M console=ttyO0,115200n8 noinitrd rw ubi.mtd=5,2048 rootfstype=ubifs root=ubi0:rootfs ip=off vram=6M notifyk.vpssm3_sva=0xBFD00000 eth=${ethaddr}"
