...
#include "WAVAudioServerMediaSubsession.hh"
#include "WAVAudioSource.hh"
#include "uLawAudioFilter.hh"
#include "SimpleRTPSink.hh"

WAVAudioServerMediaSubsession* WAVAudioServerMediaSubsession
::createNew(UsageEnvironment& env, char const* fileName, Boolean reuseFirstSource,
	    Boolean convertToULaw) {
  return new WAVAudioServerMediaSubsession(env, fileName,
					       reuseFirstSource, convertToULaw);
}

WAVAudioServerMediaSubsession
::WAVAudioServerMediaSubsession(UsageEnvironment& env, char const* fileName,
...
void WAVAudioServerMediaSubsession
...
FramedSource* WAVAudioServerMediaSubsession
...
RTPSink* WAVAudioServerMediaSubsession
...
void WAVAudioServerMediaSubsession::testScaleFactor(float& scale) {
...
float WAVAudioServerMediaSubsession::duration() const {
