...
{
public:
	WW_H264VideoServerMediaSubsession(UsageEnvironment & env, FramedSource * source, int vType);
...
public:
	...
	static WW_H264VideoServerMediaSubsession * createNew(UsageEnvironment & env, FramedSource * source, int vType);
