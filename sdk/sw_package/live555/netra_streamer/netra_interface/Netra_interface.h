/* ===========================================================================
* @file Netra_interface.h
*
* @path $(IPNCPATH)/include/
*
* @desc Netra_interface common include file
* .
* =========================================================================== */
/**
  \file Netra_interface.h

  \brief Netra_interface common include file
*/

#ifndef _NETRA_INTERFACE_
#define _NETRA_INTERFACE_
...
/**
  \defgroup AV_INTERFACE Netra interface datatypes, data structures, functions
