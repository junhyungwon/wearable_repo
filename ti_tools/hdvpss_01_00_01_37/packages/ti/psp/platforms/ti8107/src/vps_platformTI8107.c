...
/* Set the PLLs */
#define CONFIG_PLL
#define HDVPSS_CLOCK	800		//# ubx: 240M
...
Int32 Vps_platformTI8107DeviceInit(Vps_PlatformDeviceInitParams *initPrms)
{
	...
	deviceInitPrm.i2cClkKHz[VPS_PLATFORM_EVM_I2C_INST_ID] = 340;//400;
...
{
    UInt8 devAddr;
    UInt8 devAddrTvp5158[VPS_CAPT_INST_MAX] = { 0x00, 0x00, 0x5c, 0x5f }; //#B8, BE
    UInt8 devAddrPh1100k[VPS_CAPT_INST_MAX] = { 0x32, 0x00, 0x00, 0x00 };
	/* added by jhhan */
	UInt8 devAddrNvp2440h[VPS_CAPT_INST_MAX] = { 0x7F, 0x00, 0x00, 0x00 };
    ...
    switch (vidDecId)
    {
        ...
        case FVID2_VPS_VID_DEC_TVP7002_DRV:
            ...
            break;
		/* added by jhhan */
		case FVID2_VPS_VID_DEC_NVP2440H_DRV:
            devAddr = devAddrNvp2440h[vipInstId];
            break;
        default:
...
static Int32 Vps_platformTI8107SetPinMux(void)
{
	...
	//# vin1 A
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0B38) = 0x50004;   /* vin1a_clk */
	...
	//# vin1 B
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x09F0) = 0x50002;   /* vin1b_clk */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BA8) = 0x50002;   /* vin1b_d[0] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BAC) = 0x50002;   /* vin1b_d[1] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BB0) = 0x50002;   /* vin1b_d[2] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BB4) = 0x50002;   /* vin1b_d[3] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BB8) = 0x50002;   /* vin1b_d[4] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BBC) = 0x50002;   /* vin1b_d[5] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BC0) = 0x50002;   /* vin1b_d[6] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0BC4) = 0x50002;   /* vin1b_d[7] */
